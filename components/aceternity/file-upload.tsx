  ...
  return (
    <div className="h-full w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="group/file relative flex h-full w-full cursor-pointer justify-center overflow-hidden rounded-lg p-10"
      >
        <input
          ref={fileInputRef}
          ...
          <div className="relative mx-auto mt-10 w-full max-w-xl">
            ...
            {!files.length && (
              <motion.div
                ...
                className="border-chart-2 absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-dashed bg-transparent opacity-0"
              ></motion.div>
            )}
          </div>
        </div>
